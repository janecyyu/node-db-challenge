...
- [x] Explain the difference between `Relational Databases` and `SQL`.
      A: Relational Databases are databases that store their data in tables.
      SQL is used to manage databases and the data within them. It is a way to interact with a database.

- [ ] Why do tables need a `primary key`?
      A: to ensure data in the specific column is unique
